...
public class VirtualView extends Observable implements Observer {
    ...
    public void update(Observable o, Object arg) {
        if (o.getClass() == Session.class) {
            sessionHandler(arg);
        } else if (o.getClass() == GameMultiplayer.class) {
            connection.sendMessage((List) arg);
        } else if (o.getClass() == Board.class) {
            connection.forwardMessage((List) arg);
        } else if (o.getClass() == Round.class) {
            roundHandler(arg);
        } else if (o.getClass() == Player.class) {
            connection.sendMessage((List) arg);
        } else if (o.getClass() == Schema.class) {
            schemaHandler(arg);
        } else if (o.getClass() == DiceSpace.class) {
            diceSpaceHandler(arg);
        } else if (o.getClass() == RoundTrack.class) {
            roundTrackHandler(arg);
        }
    }
